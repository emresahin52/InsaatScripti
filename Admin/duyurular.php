    ...
    <section class="content">
        ...
        <!--END GERİ DÖNÜŞ UYARILARI -->
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="body">
                            <form action="islem.php?duyuru_id=<?echo $duyuru_cek["duyuru_id"]; ?>" method ="GET" class="form-horizontal">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="duyuru_link" class="form-control" value="<?php echo $duyuru_cek["duyuru_link"]; ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                        <button type="submit" name="duyurular" rows= 4; class="btn btn-primary m-t-15 waves-effect">Güncelle</button>
                                    </div>
                                </div>
                            </form>
                        </div>
